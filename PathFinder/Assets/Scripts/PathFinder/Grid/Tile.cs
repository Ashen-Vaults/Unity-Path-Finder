...
namespace PathFinder
{
    public class Tile : IQueueable
    {
        ...
        public Tile(bool _walkable, Vector3 _pos)
        {
        ...
        public Tile(bool _walkable, Vector3 _pos, int _x, int _y)
        {
            this.walkable = _walkable;
            this.myWorldPosition = _pos;
            gridX = _x;
